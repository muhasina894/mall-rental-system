...
$id=$_GET['id'];
$queryy="select request_tb.id as rid,room_tb.*,user_tb.*  from request_tb inner join user_tb on request_tb.user_id=user_tb.id inner join room_tb on room_tb.id=request_tb.room_id where request_tb.id=$id and request_tb.status='reqrejected'";
