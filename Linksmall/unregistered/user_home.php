  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-primary py-lg-2 py-2 px-sm-0 px-2">
    ...
    <a class="navbar-brand" href="#index.html">
      ...
      <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="reqcancel.php">Requests</a>
          </li>
          <!-- <li class="nav-item">
    ...
    <div class="footer-29 py-5">
        <div class="container pb-lg-3">
            ...
            <div class="row bottom-copies">
                <p class="copy-footer-29 col-lg-8">© 2023 LinksMall. All rights reserved | Design by <a
                    href="#">LinksMall</a></p>
...
<!-- </html>
        ...
        <li><a href="reqcancel.php">VIEW REQUEST </a></li>
