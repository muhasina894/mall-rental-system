  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-primary py-lg-2 py-2 px-sm-0 px-2">
    ...
    <a class="navbar-brand" href="#index.html">
      ...
      <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="editt.php">Profile</a>
          </li>   
          <li class="nav-item">
            <a class="nav-link" href="userviewrm.php">Rooms</a>
          </li>   
          <li class="nav-item">
            <a class="nav-link" href="reqstdrm.php">Requests</a>
          </li>
          <!-- <li class="nav-item">
            <a class="nav-link" href="../gallery.php">Gallery</a>
          </li> -->
          <li class="nav-item">
            <a class="nav-link" href="mycmplnt.php">My Complaints</a>
          </li>
          <li class="nav-item">
        ...
        ?>
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="uchngpass.php">Change Password</a>
    ...
    <div class="footer-29 py-5">
        <div class="container pb-lg-3">
            ...
            <div class="row bottom-copies">
                <p class="copy-footer-29 col-lg-8">© 2023 LinksMall reserved | Design by <a
                    href="#">LinksMall</a></p>
...
<!-- 
        ...
        <li><a href="../userviewrm.php">VIEW ROOMS</a></li>
        <li><a href="reqstdrm.php">VIEW REQUEST </a></li>
        <li><a href="uchngpass.php">CHANGE PASSWORD</a></li>
        <li><a href="mycmplnt.php">MY COMPLAINT</a></li>
